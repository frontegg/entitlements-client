...
class TestEntitlementsSpiceDBQuery extends EntitlementsSpiceDBQuery {
	...
	public testCreateBulkPermissionRequestItem(
		...
		scope: SchemaScope = LEGACY_SCOPE
	...
	public testCreateBulkPermissionsRequest(
		...
		return this.createBulkPermissionsRequest(scope, objectType, objectId, context, caveatContext);
	}
	...
	public testCreateManyBulkPermissionsRequest(
		...
		return this.createManyBulkPermissionsRequest(scope, objectType, objectIds, context, caveatContext);
	}
	...
	public testExecuteCommonQuery(
		...
		return this.executeCommonQuery(scope, objectType, objectId, subjectContext);
	}
	...
	public testExecuteManyCommonQuery(
		...
		return this.executeManyCommonQuery(scope, objectType, objectIds, subjectContext);
	}
}
